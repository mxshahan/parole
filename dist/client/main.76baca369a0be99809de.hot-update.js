...
const getSingleContent = exports.getSingleContent = data => ({
    type: 'SINGLE_CONTENT',
    data
});
...
class Homepage extends _react2.default.Component {
  ...
  componentDidMount() {
    _axios2.default.get('./api/content/').then(res => {}).catch(e => {
...
const mapDispatchToProps = dispatch => ({
  content: body => dispatch((0, _content.setContent)(body))
});

exports.default = (0, _reactRedux.connect)(undefined, mapDispatchToProps)(Homepage);

/***/ })

})
//# sourceMappingURL=main.76baca369a0be99809de.hot-update.js.map