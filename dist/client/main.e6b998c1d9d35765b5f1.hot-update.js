...
class Single extends _react2.default.Component {
  ...
  componentDidMount() {
    if (this.props.blogAll) {
      ...
      console.log('post');
      _axios2.default.get(`http://localhost:5000/siu/blog/${this.props.match.params.id}`).then(res => {
        // console.log(res);
...
exports.default = connect(mapStateToProps, mapDispatchToProps)(Single);

/***/ })

})
//# sourceMappingURL=main.e6b998c1d9d35765b5f1.hot-update.js.map