...
class AddNewContent extends _react2.default.Component {
    constructor(...args) {
        ...
        return _temp = super(...args), this.state = {
            ...
            if (title && category && parmalink) {
                _axios2.default.post(`/api/content/`, {
                    title, category, description, parmalink
                }, {
...
//# sourceMappingURL=main.78f922b8d2dd38098bcc.hot-update.js.map