...
exports.default = (state = {}, action) => {
    switch (action.type) {
        ...
        case 'SET_CATEGORY':
            ...
            }, state.all, state.cat_content, state.mycontent, state.single);

        case 'SET_CATEGORY_CONTENT':
            return state = _extends({
                cat_content: action.data
            }, state.all, state.category, state.mycontent, state.single);
        ...
        case 'MY_CONTENT':
            ...
            }, state.all, state.category, state.cat_content, state.single);
        case 'SINGLE_CONTENT':
            return state = _extends({
                single: action.data
...
//# sourceMappingURL=main.d975205eeb5a5ead0189.hot-update.js.map